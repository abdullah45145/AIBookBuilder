...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axiosInstance.post(apiPath.AUTH.LOGIN, formData);
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center px-4">
      <div className="max-w-md w-full bg-white rounded-3xl p-8 shadow-xl">
        ...
        <p className="text-center text-gray-500 mt-2">Continue your writing journey</p>
        ...
        <p className="text-center text-sm text-gray-500 mt-6">
          New here? <Link to="/signup" className="text-purple-600">Create account</Link>
        </p>
      </div>
    </div>
  );
